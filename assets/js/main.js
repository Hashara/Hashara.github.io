...
const smartEdModal = document.getElementById("smartEd");
...
const smartEdBtn = document.getElementById("smartEdBtn");

// Get the <span> element that closes the modal
const pumpItUpSpan = document.getElementById("pumpItUpClose");
...
const smartEdSpan = document.getElementsByClassName("close")[5];
...
smartEdBtn.onclick = function () {
    smartEdModal.style.display = "block";
}
...
smartEdSpan.onclick = function () {
    smartEdModal.style.display = "none";
}
...
window.onclick = function (event) {
    if (event.target === pumpItUpModal) {
        ...
        obbsModal.style.display = "none";
    } else if (event.target === smartEdModal) {
		smartEdModal.style.display = "none";
	}
}
